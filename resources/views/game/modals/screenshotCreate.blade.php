...
<!-- Modal -->
<div class="modal fade" id="screenshotModalCreate" tabindex="-1" role="dialog" aria-labelledby="screenshotModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <form action="{{route('screenshot.store', $game->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-header bg-purple">
                <h5 class="modal-title" id="screenshotModalLabel">Create new screenshot</h5>
            ...
            <div class="modal-body">
                @if($errors->any())
                    <div class="alert alert-danger error" id="{{session('errorsCreate') ? 'errorsCreate' : ''}}">
                        <ul>
